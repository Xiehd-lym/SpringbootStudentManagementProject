...
public class StudentInfoController {
	...
	public PageUtils list(@RequestParam Map<String, Object> params){
		...
		List<StudentInfoDO> studentInfoDOListList = studentInfoService.list(query);
		int total = studentInfoService.count(query);
		PageUtils pageUtils = new PageUtils(studentInfoDOListList, total,query.getCurrPage(),query.getPageSize());
		return pageUtils;
	}
